...
const QR_X_OFFSET = -15.6;              // Horizontal offset for QR (negative = LEFT, positive = RIGHT)
const QR_Y_POSITION = 50.1;           // Distance from top for QR code (increase to move DOWN)
